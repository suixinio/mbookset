...
//func reviewsVos(rModels []*models.Review) (ret []*review) {
...
//}
//
//func reviewVo(rModel *models.Review) (ret *review) {
//	ret = &review{
//		ID:        rModel.ID,
...
func questionsVos(qModels []*models.Question) (ret []*question) {
...
func questionVo(qModel *models.Question) (ret *question) {
	desc := ""
	...
	content = utils.TuneHTML(content)
	title := pangu.SpacingText(qModel.TitleZhCN)

	ret = &question{
		ID:          qModel.ID,
		Path:        qModel.SourceID,
		Title:       title,
		Description: desc,
...
func answersVos(aModels []models.Answer) (ret []*answer) {
	//func answersVos(aModels []*models.Answer) (ret []*answer) {
...
func answerVo(aModel *models.Answer) (ret *answer) {
