...
func (c *BlogController) List() {
	...
	blogList, totalCount, err = models.NewBlog().FindToPager(pageIndex, pageSize, 0, "")
	...
	if totalCount > 0 {
		...
		html := utils.NewPaginations(4, totalCount, pageSize, pageIndex, beego.URLFor("BlogController.List"), "")
